...
export default function WovenImageList() {
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', minHeight: '100vh', backgroundColor: '#fff', padding: '20px' }}>
      ...
      {/* Footer Grid Line Style */}
      <Box sx={{ mt: 10, pt: 4, borderTop: '1px solid #e0e0e0', textAlign: 'center' }}>
        <Typography variant="body2" sx={{ fontFamily: 'Source Code Pro', fontSize: '10px', letterSpacing: '2px', color: '#999' }}>
          {'© '}
          <Link color="inherit" href="/" sx={{ textDecoration: 'none', fontWeight: 'bold' }}>WORKS</Link>{' '}
